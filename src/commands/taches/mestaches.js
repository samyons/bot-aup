...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!user) {
            return interaction.editReply({ content: "Vous ne faîtes pas partie du projet AUP ! Si vous pensez que c'est une erreur, contactez un coordinateur.", ephemeral: true });
        }
        ...
        if (!tasks || tasks.length === 0) {
            return interaction.editReply({ content: `Aucune tâche trouvée pour ${userName} dans l'équipe ${userTeam}.`, ephemeral: true });
        }
